        ...
        <center>
            ...
            <h2>Registration</h2>
                <form action="../api/register.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input style="width: 24%" type="email" name="email" placeholder="Email Address" required><br><br>
                    <input style="width: 31%" type="text" name="add" placeholder="Home Address" required><br><br>
